...
module.exports = function mixTouchablePrograms(...programs) {
    return class TouchableMixProgram extends LightProgram {
        ...
        touch(data){
            this.programs.forEach((p, i) => {
                if (typeof p.programInstance.touch === "function"){
                    console.log('touchable mix touch')
                    p.programInstance.touch(data);
                }
            })
        }
