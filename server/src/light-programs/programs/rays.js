...
module.exports = class Rays extends SoundBasedFunction {
    ...
    updateRay(ray) {
        if(this.config.useSoundSpeed) {
            ...
            ray.pos = (ray.pos + (this.bassFastPeakDecay || 0) * ray.speed * 3 *  this.config.globalSpeed * ray.direction)
        } else {
    ...
    static presets() {
        return {
            ...
            colorSmoke: {brillo: 0.5, decay: 0.9, globalSpeed: 5,  colorSaturationRange: 0.3, numberOfParticles: 30, colorHueAmplitude: 1},
            ...
            slowBlue: {decay: 0.92, brillo: 0.4, globalSpeed: 1,  colorSaturationRange: 0.4, numberOfParticles: 15, colorHueAmplitude: 0.10, colorHueOffset: 0.57},
            fireFast: {brillo: 0.5, decay: 0.8, globalSpeed: 3,  colorSaturationRange: 0.07, numberOfParticles: 90, colorHueAmplitude: 0.12, colorHueOffset: 0.98, singleDirection: true},
            ...
            fireSlowSingle: {brillo: 0.1, decay: 0.95, globalSpeed: 0.25,  colorSaturationRange: 0.07, numberOfParticles: 50, colorHueAmplitude: 0.12, colorHueOffset: 0.98, singleDirection: true}
        }
    }
