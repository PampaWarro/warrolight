...
const seg = 1000;
const schedule = [
    {duration: 2*60*seg, program: programsByShape({trianguloBottom: [animateParamProgram(VolumeDot, 'numberOfOnLeds', 60*8, n => Math.min(40, n+1)), {multiplier: 2, numberOfOnLeds: 1}]})},
